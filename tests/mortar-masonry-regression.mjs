...
try{
 ...
 for(let i=0;i<100;i++)m.update(.01);return{packed,hit:hit?{point:{...hit.point},normal:{...hit.normal}}:null,coverage:m.coverage(q.point),telemetry:m.telemetry};},{dx,dy,oblique}));if(load>=3&&await page.evaluate(()=>window.__mortarVolumeQA.m.ready(window.__mortarVolumeQA.point)))break;}
