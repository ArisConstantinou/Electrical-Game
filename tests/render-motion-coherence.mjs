...
try{for(const mobile of [false,true]){
 ...
 if(mobile){const b=await page.locator('#joystick').boundingBox();await cdp.send('Input.dispatchTouchEvent',{type:'touchStart',touchPoints:[{x:b.x+b.width*.82,y:b.y+b.height*.5,id:1}]});}
