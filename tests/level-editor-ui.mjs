...
const run = async (name, viewport, mobile) => {
  ...
  if (mobile) { await page.locator('.level-editor__bottom-nav [data-editor-tab="select"]').click(); await page.locator('#level-browser-toggle').click(); }
  ...
  if (mobile) await page.locator('.level-editor__bottom-nav [data-editor-tab="build"]').click();
  await page.locator('#level-add-brick').click();
  if (mobile) await page.locator('#level-details-toggle').click();
  ...
  if (mobile) await page.locator('.level-editor__bottom-nav [data-editor-tab="select"]').click();
  ...
  await page.locator('[data-axis="z"]').dispatchEvent('change');
  if (mobile) await page.locator('.level-editor__bottom-nav [data-editor-tab="starts"]').click();
  ...
  if (mobile) await page.locator('.level-editor__bottom-nav [data-editor-tab="save"]').click();
  await page.locator(mobile ? '#level-save-mobile' : '#level-save').click();
