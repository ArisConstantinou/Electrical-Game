...
export class Game {
  ...
  renderState(): string {
    ...
    return JSON.stringify({
      ...
      workSurface: { freeSprayMarks: this.room.brickWall.freeMarkCount, damagedBricks: this.room.brickWall.damagedBrickCount, destroyedBricks: this.room.brickWall.destroyedBrickCount, recessedBricks: this.room.brickWall.recessedBrickCount, carvedCells: this.room.brickWall.carvedCellCount, chaseDepthMm: this.room.brickWall.chaseDepthMm, chaseBackSurfaces: this.room.brickWall.chaseBackSurfaceCount, chaseSideWalls: this.room.brickWall.chaseSideWallCount, activeFragments: this.chasing.activeFragmentCount, airborneFragments: this.chasing.airborneFragmentCount, settledFragments: this.chasing.settledFragmentCount, rubblePileHeight: Number(this.chasing.rubblePileHeight.toFixed(3)), unsupportedSettledFragments: this.chasing.unsupportedSettledFragmentCount, overlappingSettledFragments: this.chasing.settledOverlapCount, anchoredRemnants: this.room.brickWall.anchoredRemnantCount, floatingStaticPieces: this.room.brickWall.floatingStaticPieceCount, unsupportedAnchoredRemnants: this.room.brickWall.unsupportedAnchoredRemnantCount, fracturePatterns: this.room.brickWall.uniqueFracturePatternCount, sprayMode: this.sprayMode, sprayColor: SPRAY_COLORS[this.sprayColorIndex].name, hammerMode: this.hammerMode, aimControlMode: this.aimControlMode, aimInputMode: this.aimInputMode, aimProfile: this.aimProfile, wallAssist: this.wallAssistEnabled, proximityPrecision: Number(this.player.wallAssistAmount.toFixed(3)) },
