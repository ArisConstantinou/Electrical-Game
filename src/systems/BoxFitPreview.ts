...
export class BoxFitPreview {
  ...
  update(camera:THREE.Camera,preset:string,enabled:boolean,retrieving:boolean,dt:number,canReach:(point:THREE.Vector3)=>boolean,guide=false,placedDepthM=0):void {
