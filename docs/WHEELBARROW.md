...
Acceleration and turning disturb the mortar surface. Excess inclination spills material; abrupt movement can tip the cart in any direction. Parcels retain mass and produce impact-dependent footprints. Pick up the physical shovel with **E**, aim at a spill and press **E** to scoop 3.5 kg, then aim at the parked cart and press **E** to return it. Capacity is 114 kg. Existing sand and mixer interactions remain available when the shovel is empty.
